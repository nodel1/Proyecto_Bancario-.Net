...
{
    public partial class FFecha : Form
    {
        /// <summary>
        /// Almacena la fecha seleccionada por el usuario.
        /// </summary>
        private DateTime fecha;

        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="FFecha"/>.
        ...
        /// <summary>
        /// Maneja el evento de clic en el botón Aceptar, guarda la fecha seleccionada
        ...
        /// </summary>
        private void FFecha_Load(object sender, EventArgs e)
        {
        }
    }
}
